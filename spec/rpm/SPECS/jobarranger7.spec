...
if [ -f %{_sysconfdir}/jobarranger/jobarg_agentd.conf ]; then
    cp %{_sysconfdir}/jobarranger/jobarg_agentd.conf %{_sysconfdir}/jobarranger/jobarg_agentd.conf.new
fi
...
/usr/sbin/useradd -c "Job Arranger user" \
        -s /sbin/nologin -r -d %{_sysconfdir}/zabbix zabbix 2> /dev/null || :
if [ -f %{_sysconfdir}/jobarranger/jobarg_server.conf ]; then
    cp %{_sysconfdir}/jobarranger/jobarg_server.conf %{_sysconfdir}/jobarranger/jobarg_server.conf.new
fi
if [ -f %{_sysconfdir}/jobarranger/jobarg_monitor.conf ]; then
    cp %{_sysconfdir}/jobarranger/jobarg_monitor.conf %{_sysconfdir}/jobarranger/jobarg_monitor.conf.new
fi
...
%post agentd
if [ -f %{_sysconfdir}/jobarranger/jobarg_agentd.conf.new ]; then
    if [ -f %{_sysconfdir}/jobarranger/jobarg_agentd.conf.rpmsave ]; then
        echo "Removing the backup file jobarg_agentd.conf.rpmsave since the old jobarg_agentd.conf remains."
        rm -rf %{_sysconfdir}/jobarranger/jobarg_agentd.conf.rpmsave
    fi
    if [ -f %{_sysconfdir}/jobarranger/jobarg_agentd.conf ]; then
        echo "Saving new package configuration as jobarg_agentd.conf.rpmnew"
        cp %{_sysconfdir}/jobarranger/jobarg_agentd.conf %{_sysconfdir}/jobarranger/jobarg_agentd.conf.rpmnew
    fi
    mv %{_sysconfdir}/jobarranger/jobarg_agentd.conf.new %{_sysconfdir}/jobarranger/jobarg_agentd.conf
fi
...
if [ -f %{_sysconfdir}/jobarranger/jobarg_server.conf.new ]; then
    if [ -f %{_sysconfdir}/jobarranger/jobarg_server.conf.rpmsave ]; then
        echo "Removing the backup file jobarg_server.conf.rpmsave since the old jobarg_server.conf remains."
        rm -rf %{_sysconfdir}/jobarranger/jobarg_server.conf.rpmsave
    fi
    if [ -f %{_sysconfdir}/jobarranger/jobarg_server.conf ]; then
        echo "Saving new package configuration as jobarg_server.conf.rpmnew"
        cp %{_sysconfdir}/jobarranger/jobarg_server.conf %{_sysconfdir}/jobarranger/jobarg_server.conf.rpmnew
    fi
    mv %{_sysconfdir}/jobarranger/jobarg_server.conf.new %{_sysconfdir}/jobarranger/jobarg_server.conf
fi
if [ -f %{_sysconfdir}/jobarranger/jobarg_monitor.conf.new ]; then
    if [ -f %{_sysconfdir}/jobarranger/jobarg_monitor.conf.rpmsave ]; then
        echo "Removing the backup file jobarg_monitor.conf.rpmsave since the old jobarg_monitor.conf remains."
        rm -rf %{_sysconfdir}/jobarranger/jobarg_monitor.conf.rpmsave
    fi
    if [ -f %{_sysconfdir}/jobarranger/jobarg_monitor.conf ]; then
        echo "Saving new package configuration as jobarg_monitor.conf.rpmnew"
        cp %{_sysconfdir}/jobarranger/jobarg_monitor.conf %{_sysconfdir}/jobarranger/jobarg_monitor.conf.rpmnew
    fi
    mv %{_sysconfdir}/jobarranger/jobarg_monitor.conf.new %{_sysconfdir}/jobarranger/jobarg_monitor.conf
fi
...
then
  ...
  if ls %{_sysconfdir}/jobarranger/jobarg_agentd.conf.* 1> /dev/null 2>&1; then
    rm -rf %{_sysconfdir}/jobarranger/jobarg_agentd.conf.*
  fi
  rm -rf %{_localstatedir}/log/jobarranger/jobarg_agentd.*
  rm -rf %{_localstatedir}/lib/jobarranger/tmp/*
fi
...
if [ $1 -eq 0 ]; then  
  ...
  if ls %{_sysconfdir}/jobarranger/jobarg_server.conf.* 1> /dev/null 2>&1; then
    rm -rf %{_sysconfdir}/jobarranger/jobarg_server.conf.*
  fi
  if ls %{_sysconfdir}/jobarranger/jobarg_monitor.conf.* 1> /dev/null 2>&1; then
    rm -rf %{_sysconfdir}/jobarranger/jobarg_monitor.conf.*
  fi
  rm -rf %{_localstatedir}/log/jobarranger/jobarg_server.*
  rm -rf %{_localstatedir}/log/jobarranger/jobarg_montor.*
  rm -rf %{_localstatedir}/log/jobarranger/job
  rm -rf %{_localstatedir}/log/jobarranger/jobstatus.chk
  rm -rf %{_localstatedir}/log/jobarranger/session_dbc_locks
fi
...
%attr(0644,zabbix,zabbix) %{_sysconfdir}/jobarranger/jobarg_agentd.conf
...
%attr(0755,zabbix,zabbix) %dir %{_sysconfdir}/jobarranger
%attr(0644,zabbix,zabbix) %{_sysconfdir}/jobarranger/jobarg_server.conf
%attr(0644,zabbix,zabbix) %{_sysconfdir}/jobarranger/jobarg_monitor.conf
%attr(0755,zabbix,zabbix) %dir %{_sysconfdir}/jobarranger/extendedjob
...
%changelog
* Fri Dec 20 2024 Copyright Daiwa Institute of Research Ltd. All Rights Reserved. <https://www.jobarranger.info/jaz/jaz_release_note.html> 6.1.9
- Lastest RPM relese
