...
-- Job Arranger delete garbage jobnets data SQL for MySQL (Ver 6.0.8)  - 2024/10/02 -
...
WHERE status in (3, 5) AND 
end_time <= YOUR_DELETE_DATE AND 
inner_jobnet_main_id NOT IN (SELECT inner_jobnet_id 
